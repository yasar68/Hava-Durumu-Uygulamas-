        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 -mt-1">by WeatherApp</p>
            </div>
          </div>
          
          {/* Navigation Links */}
          <div className="flex space-x-1 bg-white/80 backdrop-blur-sm rounded-full p-1 shadow-lg border border-gray-200/50">
            <NavLink
              to="/"
              className={({ isActive }) =>
